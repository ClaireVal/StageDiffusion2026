...
alpha = [1, 0.001, 0.01, 0.1, 10, 100, 1000]
...
for a in alpha:
    for cD in cDef:
        ...
        np.savez(f"Traj_swap_{swap}_tpsVariable_{tpsVar}_N_{N}_cD_{cD}_alpha_{a}.npz", pos_reelle=pos_reelle, Densite=Densite, positions=positions, listeDefauts=listeDefauts, defautsFin = defauts)
